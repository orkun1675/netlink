...
const (
	GENL_FOU_ATTR_UNSPEC = iota
	GENL_FOU_ATTR_PORT
	GENL_FOU_ATTR_AF
	GENL_FOU_ATTR_IPPROTO
	GENL_FOU_ATTR_TYPE
	GENL_FOU_ATTR_REMCSUM_NOPARTIAL
	GENL_FOU_ATTR_MAX = GENL_FOU_ATTR_REMCSUM_NOPARTIAL
)

const (
	GENL_FOU_CMD_UNSPEC = iota
	GENL_FOU_CMD_ADD
	GENL_FOU_CMD_DEL
	GENL_FOU_CMD_GET
	GENL_FOU_CMD_MAX = GENL_FOU_CMD_GET
)

const (
	GENL_FOU_ENCAP_UNSPEC = iota
	GENL_FOU_ENCAP_DIRECT
	GENL_FOU_ENCAP_GUE
)
